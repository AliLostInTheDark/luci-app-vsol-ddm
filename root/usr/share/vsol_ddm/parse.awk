...
END {
	...
	printf("    \"temp_low_warn\": 0.00,\n")
	printf("    \"temp_high_warn\": 65.00,\n")
	printf("    \"temp_high_alarm\": 70.00,\n")
	printf("    \"voltage_low_alarm\": 2.95,\n")
	printf("    \"voltage_low_warn\": 3.02,\n")
	printf("    \"voltage_high_warn\": 3.57,\n")
	printf("    \"voltage_high_alarm\": 3.65,\n")
	printf("    \"bias_low_alarm\": 0.00,\n")
	printf("    \"bias_low_warn\": 2.00,\n")
	printf("    \"bias_high_warn\": 30.00,\n")
	printf("    \"bias_high_alarm\": 40.00,\n")
	printf("    \"descriptors\": {\n")
	printf("      \"rx\": \"Optical Rx power at the ONU, in dBm. Operating range -28 to -8 dBm. Internal calibration: +/-2 dB. Rx light is at 1490 nm (downstream).\",\n")
	printf("      \"tx\": \"Optical Tx power at the ONU, in dBm. Operating range 0 to +4 dBm. Internal calibration: +/-2 dB. Tx light is at 1310 nm (upstream).\",\n")
	printf("      \"temp\": \"Transceiver temperature in degrees Celsius. Internal calibration: +/-3 C. Operating range 0 to 70 C.\",\n")
	printf("      \"volt\": \"Supply voltage VCC. Expects close to constant 3.3 V. Internal calibration: +/-3%%.\",\n")
	printf("      \"bias\": \"Laser diode bias current in mA. Internal calibration: +/-10%%.\"\n")
	printf("    },\n")
	printf("    \"calibrations\": {\n")
	printf("      \"rx\": \"+/-2 dB\",\n")
	printf("      \"tx\": \"+/-2 dB\",\n")
